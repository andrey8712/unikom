            ...
            <form>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12">
                                <label>{{$this->getAttributeName('title')}}</label>
                    ...
                    <fieldset class="">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-12">
                                    <label>Баланс</label>
                                    <input type="number" class="form-control" wire:model="price_limit">
                                    @error('price_limit')<label class="validation-invalid-label">{{ $message }}</label>@enderror
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
